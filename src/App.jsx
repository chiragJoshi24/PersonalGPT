                ...
                <Route path="/" element={
                    <div className='h-screen bg-backgroundDark flex flex-col justify-center items-center'>
                        ...
                        <div className='border-black h-[36rem] border-solid border-[1px] w-96 gap-4 rounded-xl flex flex-col items-center justify-center bg-backgroundLight'>
                            ...
                            <input type="text" placeholder='Email' className='h-8 pl-3 rounded-lg text-black'/>
                            <input type="password" name="password" placeholder='Password'  className='h-8 pl-3 rounded-lg text-black'/>
                            ...
                            <Link to="/home" className='text-black hover:underline'>Continue as a guest</Link>
                        </div>
                    </div>
                } />
